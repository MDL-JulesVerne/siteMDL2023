    ...
    return (
        <Layout>
            <Box sx={{ p: 5 }}>
                ...
                <p>
                    En vigueur au 15/01/2023
                </p>

                <p>
                    Conformément aux dispositions des Articles 6-III et 19 de la Loi n°2004-575 du 21 juin 2004 pour la Confiance dans l’économie numérique, dite L.C.E.N., il est porté à la connaissance des utilisateurs et visiteurs, ci-après l'"Utilisateur", du site citedesvestiges.fr , ci-après le "Site", les présentes mentions légales.
                </p>
                <p>
                ...
                <p>
                    L’édition et la direction de la publication du Site est assurée par MDL Jules Verne ci-après L'"EDITEUR".
                </p>

                <h2>ARTICLE 2 - L'HEBERGEUR</h2>
                <p>
                    L'hébergeur du Site est la société Vercel Inc., dont le siège social est situé au 340 S Lemon Ave #4133 Walnut, CA 91789, US
                </p>
                ...
                <p>
                    ...
                    · par mail à l'adresse email mdljulesvernesnantes@gmail.com
                ...
                <h2>ARTICLE 5 - Contenu du site</h2>
                <p>
